...
public class NERDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String serializedClassifier = "/run/media/demo/bb92bf31-b049-4d65-8e71-5a6a0cb44d49/stanford-postagger-full-2020-11-17/NER-classifiers/english.all.3class.distsim.crf.ser.gz";
    ...
    */
    ...
    if (true) {
      ...
      */
      ...
      String fileContents = "Verner Egerland, Lund University  Abstract "
      		+ "."
