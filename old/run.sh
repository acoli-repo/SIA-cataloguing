...
then 
	java -Dfile.encoding=UTF8 -classpath $CLASSPATH org.acoli.glaser.metadata.pdf.$*; #could also add  -Dlog4j.configuration=file:'src/log4j.properties' for another log4j config
fi;